...
?>
  <div class="col-sm-4">
    <div class="card">
        <img src="<?= empty($data['gambar']) ? BASE_ASSETS . 'uploads/noimage.jpg'  : BASE_ASSETS . 'uploads/'.$data['gambar'] ?>"  class="card-img-top" alt="<?= $data['judul'] ?>">
        <div class="card-body">
            <h5 class="card-title"><?= $data['judul'] ?></h5>
            <p class="card-text"><?= word_limiter($data['sinopsis'] , 20)?>  <a href="<?= base_url("buku/detail/{$data['id']}") ?>" class="btn btn-sm btn-primary">Detail</a></p>
            <dl>
  <dt>ISBN</dt>
  <dd><?= $data['isbn'] ?></dd>
